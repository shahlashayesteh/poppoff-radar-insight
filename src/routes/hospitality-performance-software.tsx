        ...
        <section className="px-6 py-16">
          <div className="mx-auto max-w-6xl">
            ...
            <ol className="mt-8 grid md:grid-cols-5 gap-4">
              {["Manager uploads weekly sales data.","PoppOff identifies revenue gaps, opportunities and focus items for each server.","PoppOff creates personal scorecards.","Servers see their weekly focus.","Managers see coaching priorities and uplift."].map((step, i) => (
