...
const URL = "https://poppoffstats.com/restaurant-leaderboard-software";
const TITLE = "Restaurant Leaderboard Software — PoppOff";
const DESC = "PoppOff is restaurant leaderboard software — shared scoreboards built on POS data that give servers visibility into their numbers and build friendly team momentum.";

export const Route = createFileRoute("/restaurant-leaderboard-software")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Restaurant Leaderboard Software", item: URL },
          ],
        }),
      },
    ],
      ...
      <main className="flex-1">
        <section className="px-6 pt-14 pb-12">
          <div className="mx-auto max-w-4xl">
            <div className="text-xs uppercase tracking-widest text-brand-green font-bold">Restaurant leaderboard software</div>
            <h1 className="mt-3 font-display font-extrabold tracking-tight text-4xl md:text-6xl leading-[1.05]">
              A shared <span style={{ color: "var(--brand-green)" }}>scoreboard</span> your team actually wants to look at.
            </h1>
            <p className="mt-6 text-base md:text-lg text-foreground/75 max-w-2xl">
              PoppOff turns POS data into shared scoreboards and personal scorecards — so every server sees where they stand and what to grow next. Friendly momentum, not pressure.
            </p>
        ...
        <section className="px-6 py-12 bg-canvas border-t border-border">
          <div className="mx-auto max-w-6xl grid md:grid-cols-3 gap-6">
            {[
              { t: "Friendly competition", d: "A shared scoreboard celebrates wins and builds weekly momentum across the team." },
              { t: "Build streaks", d: "Daily and weekly streaks give servers a reason to come back and beat their last shift." },
              { t: "Visibility, not pressure", d: "Designed around shared visibility and operational clarity — not punitive ranking." },
            ].map((f) => (
        ...
        <section className="px-6 py-12 bg-canvas border-t border-border">
          <div className="mx-auto max-w-4xl">
            <h2 className="font-display text-3xl md:text-4xl font-extrabold tracking-tight">What's on the scoreboard</h2>
            <ul className="mt-6 grid sm:grid-cols-2 gap-3 text-sm">
              {["Per-server scorecards","Streaks and personal bests","Menu category leaders","Weekly Top 3 highlights","Milestones and rewards","Manager view of team momentum"].map((f) => (
