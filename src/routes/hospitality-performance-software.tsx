...
const URL = "https://poppoffstats.com/hospitality-performance-software";
const TITLE = "Hospitality Performance Software — PoppOff";
const DESC = "PoppOff is hospitality performance software for multi-venue restaurant operators — per-server scorecards, weekly coaching priorities, and shared visibility across the group.";

export const Route = createFileRoute("/hospitality-performance-software")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Hospitality Performance Software", item: URL },
          ],
        }),
      },
    ],
      ...
      <main className="flex-1">
        <section className="px-6 pt-14 pb-12">
          <div className="mx-auto max-w-4xl">
            <div className="text-xs uppercase tracking-widest text-brand-green font-bold">Hospitality performance software</div>
            <h1 className="mt-3 font-display font-extrabold tracking-tight text-4xl md:text-6xl leading-[1.05]">
              Performance visibility for <span style={{ color: "var(--brand-green)" }}>hospitality groups</span>.
            </h1>
            <p className="mt-6 text-base md:text-lg text-foreground/75 max-w-2xl">
              PoppOff gives multi-venue operators a consistent, shared view of server and team performance — built on the POS data each venue already captures.
            </p>
        ...
        <section className="px-6 py-12 bg-canvas border-t border-border">
          <div className="mx-auto max-w-6xl grid md:grid-cols-3 gap-6">
            {[
              { t: "Built for groups", d: "One consistent scorecard format across venues — designed for hospitality operators." },
              { t: "Coaching consistency", d: "Every venue runs the same weekly coaching cadence built on the same numbers." },
              { t: "Operational clarity", d: "Managers see team performance and coaching priorities at a glance." },
            ].map((f) => (
        ...
        <section className="px-6 py-16">
          <div className="mx-auto max-w-6xl">
            ...
            <ol className="mt-8 grid md:grid-cols-5 gap-4">
              {["Manager uploads weekly sales data.","PoppOff identifies revenue gaps, opportunities and focus items for each server.","Each server gets personalised scorecards, targets, leaderboards and coaching insights.","Servers see their weekly focus.","Managers see coaching priorities and uplift."].map((step, i) => (
        ...
        <section className="px-6 py-12 bg-canvas border-t border-border">
          <div className="mx-auto max-w-4xl">
            <h2 className="font-display text-3xl md:text-4xl font-extrabold tracking-tight">For multi-venue operators</h2>
            <ul className="mt-6 grid sm:grid-cols-2 gap-3 text-sm">
              {["Per-venue and per-server scorecards","Weekly coaching priorities per manager","Menu intelligence and category focus","Streaks, milestones, personal bests","Shared scoreboards for friendly momentum","Designed for hospitality groups"].map((f) => (
