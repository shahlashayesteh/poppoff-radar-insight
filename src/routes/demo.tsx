...
const roles = [
  { label: "Server", to: "/demo/server", icon: User, sub: "Sarah · Front of house", c: "var(--brand-green)" },
  { label: "Manager", to: "/demo/manager", icon: Shield, sub: "The Demo Restaurant", c: "var(--brand-orange)" },
